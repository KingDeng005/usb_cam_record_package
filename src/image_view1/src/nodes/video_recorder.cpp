...
int main(int argc, char** argv)
{
    ...
    local_nh.param("filename", filename, std::string("/home/fuheng/usb_cam_avi/output.avi"));
    bool stamped_filename;
    local_nh.param("stamped_filename", stamped_filename, false);
    local_nh.param("fps", fps, 30);
    ...
    local_nh.param("ns", ns, std::string("usb_cam1"));
    ...
    std::string topic = nh.resolveName("/"+ns+"/usb_cam/image_raw");
